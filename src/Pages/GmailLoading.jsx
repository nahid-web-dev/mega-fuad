...
const GmailLoading = () => {
  ...
  if (status == 'loading') {
    return (
      <div className='h-dvh w-full flex justify-center items-center'>
        <div className=' h-60 z-20 bg-gray-900 w-[90%] p-5 rounded-lg shadow-lg'>
          <div className="flex items-center justify-center h-full">
            <div className="animate-spin rounded-full h-16 w-16 border-t-4 border-b-4 border-white border-opacity-75">
            </div>
          </div>
        </div>
      </div>
  ...
  if (status == 'wrongPass') {
    return (
      ...
      <div className='h-dvh w-full flex justify-center items-center'>
        <div className=' z-20 bg-gray-100 w-[90%] p-5 rounded-lg shadow-lg'>
          ...
          <div className="mt-6 text-center">
            <button
              onClick={() => navigate(`/${username}/gmail-login`)}
